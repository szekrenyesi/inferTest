...
$file = "../../prod/data/result/" . $_GET['file'];
$submitdate = date ("Y-m-d H:i:s", filemtime($file));
$json = file_get_contents($file);
$obj = json_decode($json, true);
$user = substr($_GET['file'],0,6);
$task = substr($_GET['file'],9,1);
$sql = "SELECT convert(fullname using utf8) as fullname from students WHERE neptun = '" . $user . "';";
...
$css->setAttribute("href","../modules/css/result.css?v1.1");
